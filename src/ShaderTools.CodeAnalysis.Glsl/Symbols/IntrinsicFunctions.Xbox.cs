...
namespace ShaderTools.CodeAnalysis.Glsl.Symbols
{
    internal static partial class IntrinsicFunctions
    {
        ...
        private static IEnumerable<FunctionSymbol> CreateXboxFunctions()
        {
            ...
            allFunctions.AddRange(Create1(
                "__XB_Sin_F32",
                "Generates an AMD GCN 'v_sin_f32' instruction without performing domain fixup as per use of Glsl 'sin'.",
                new[] { IntrinsicTypes.Float },
                "value", "Value to pass to v_sin_f32."));

            allFunctions.AddRange(Create1(
                "__XB_Cos_F32",
                "Generates an AMD GCN 'v_cos_f32' instruction without performing domain fixup as per use of Glsl 'cos'.",
                new[] { IntrinsicTypes.Float },
