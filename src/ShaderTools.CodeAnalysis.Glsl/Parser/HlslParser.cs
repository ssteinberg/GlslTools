...
{
    internal partial class GlslParser
    {
        ...
        public GlslParser(ILexer lexer, LexerMode mode = LexerMode.Syntax)
        {
            _lexer = lexer;
            _mode = mode;
        ...
        {
            var diagnostic = Diagnostic.Create(GlslMessageProvider.Instance, node.SourceRange, (int) diagnosticId, args);
