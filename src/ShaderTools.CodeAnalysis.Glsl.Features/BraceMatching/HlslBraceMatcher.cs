...
namespace ShaderTools.CodeAnalysis.Glsl.BraceMatching
{
    [ExportLanguageService(typeof(IBraceMatcher), LanguageNames.Glsl)]
    internal sealed class GlslBraceMatcher : IBraceMatcher
    {
        private readonly List<Tuple<SyntaxKind, SyntaxKind>> _matchingKinds;

        public GlslBraceMatcher()
        {
