...
// File: POM.Glsl
//
// Glsl file containing shader functions for Parallax Occlusion Mapping.
//
...
{ 
   ...
   // in Glsl and is very sensitive to specific syntax. When converting to other examples,
