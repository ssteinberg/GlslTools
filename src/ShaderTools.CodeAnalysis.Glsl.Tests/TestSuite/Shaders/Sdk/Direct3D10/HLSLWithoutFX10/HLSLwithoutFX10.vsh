//-----------------------------------------------------------------------------
// File: GlslwithoutEffects.vsh
//
// Desc: The vertex shader file for the GlslWithoutFX sample.  It contains a vertex 
...
VS_OUTPUT Ripple( in float2 vPosition : POSITION )
{
    ...
    // This Glsl intrinsic computes returns both the sine and cosine of x
    sincos( x, fSin, fCos );
