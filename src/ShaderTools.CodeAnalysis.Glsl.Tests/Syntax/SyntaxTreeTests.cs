...
namespace ShaderTools.CodeAnalysis.Glsl.Tests.Syntax
{
...
float b;
            ...
            var syntaxTree = SyntaxFactory.ParseSyntaxTree(SourceText.From(code, "__Root__.Glsl"), options);
...
float bar;
";
            return SyntaxFactory.ParseSyntaxTree(SourceText.From(text, "__Root__.Glsl"), fileSystem: fileSystem);
        }
    }
}
