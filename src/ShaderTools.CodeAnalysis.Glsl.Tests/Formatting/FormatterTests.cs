...
#line  20  ""Myfile.Glsl"" ", includes: includes);
        }
...
";
            ...
            var includes = new Dictionary<string, string>
            {
                { "BadlyFormed.Glsl", "{ float4 position;" }
            };
...
");
            ...
            bool allowSyntaxErrors = false)
        {
            Func<string, SyntaxTree> parse = code =>
                SyntaxFactory.ParseSyntaxTree(SourceText.From(code, "__RootFile__.Glsl"),
