...
namespace ShaderTools.CodeAnalysis.Glsl.SymbolSearch
{
    [ExportLanguageService(typeof(ISymbolSearchService), LanguageNames.Glsl)]
    internal sealed class GlslSymbolSearchService : ISymbolSearchService
    {
