...
namespace ShaderTools.CodeAnalysis.Editor.Glsl.BraceCompletion
{
    [ExportLanguageService(typeof(IEditorBraceCompletionSessionFactory), LanguageNames.Glsl)]
    internal sealed class GlslEditorBraceCompletionSessionFactory : IEditorBraceCompletionSessionFactory
    {
        ...
        {
            return new GlslEditorBraceCompletionSession(document);
        }

        private sealed class GlslEditorBraceCompletionSession : IEditorBraceCompletionSession
        {
            private readonly Document _document;

            public GlslEditorBraceCompletionSession(Document document)
            {
                _document = document;
            }
