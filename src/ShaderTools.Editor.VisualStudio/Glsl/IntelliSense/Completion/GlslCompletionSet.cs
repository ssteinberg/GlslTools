...
{
    internal sealed class GlslCompletionSet : CompletionSet
    {
        ...
        public GlslCompletionSet(ICompletionSession session, CompletionModelManager completionModelManager, DispatcherGlyphService glyphService)
        {
            _session = session;
